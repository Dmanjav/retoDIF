...
INSERT INTO Comida (`idComida`, `idComedor`,`entrada`, `plato`, `postre`) VALUES
(1, 1,'Ensalada', 'Bistec a la mexicana', 'Duraznos en almíbar'),
(2, 4,'Sopa de fideo', 'Tacos dorados de pollo', 'Gelatina'),
(3, 2,'Arroz', 'Pozole', 'Plátanos con crema'),
(4, 5,'Arroz Blanco', 'Tacos Dorados', 'Durazno'),
(5, 17,'Arroz Rojo', 'Pieza de pollo', 'Durazno'),
(6, 18,'Sopa de Verduras', 'Filete de pescado', 'Tuna'),
(7, 9,'Sopa de habas', 'Tostadas de Tinga', 'Gelatina'),
(8, 1,'Caldo de pollo', 'Enchiladas', 'Flan'),
(9, 5,'Espagueti', 'Birria', 'Fresas con crema'),
(10, 3, 'Ensalada', 'Mole poblano', 'Pastel de chocolate'),
(11, 6, 'Crema de champiñones', 'Chiles en nogada', 'Helado de vainilla'),
(12, 8, 'Sopa de lentejas', 'Carnitas', 'Tres leches'),
(13, 10, 'Sopa de tortilla', 'Cochinita pibil', 'Mousse de mango'),
(14, 12, 'Tacos al pastor', 'Tamales', 'Gelatina de frutas'),
(15, 15, 'Sopa de cebolla', 'Pescado a la veracruzana', 'Tarta de manzana'),
(16, 20, 'Ensalada de aguacate', 'Costillas BBQ', 'Helado de fresa'),
(17, 22, 'Sopa de garbanzos', 'Enchiladas verdes', 'Flan casero'),
(18, 25, 'Tacos de carnitas', 'Chiles rellenos', 'Pudín de pan'),
(19, 27, 'Crema de espárragos', 'Pollo asado', 'Pastel de queso'),
(20, 30, 'Sopa de pollo', 'Tacos de pescado', 'Tiramisú'),
(21, 32, 'Ensalada César', 'Ceviche de camarones', 'Tarta de chocolate'),
(22, 34, 'Sopa de zanahoria', 'Chapulines', 'Gelatina de piña'),
(23, 7, 'Sopa de fideos', 'Tacos al pastor', 'Tiramisú'),
(24, 14, 'Arroz con leche', 'Barbacoa de res', 'Helado de vainilla'),
(25, 19, 'Sopa de tomate', 'Chicharrón en salsa verde', 'Flan casero'),
(26, 23, 'Tacos de carnitas', 'Mole negro', 'Pastel de chocolate'),
(27, 28, 'Sopa de papa', 'Tacos de barbacoa', 'Tres leches'),
(28, 31, 'Sopa de calabaza', 'Chiles en nogada', 'Mousse de mango'),
(29, 33, 'Tacos de pollo', 'Tamales de elote', 'Gelatina de frutas'),
(30, 35, 'Crema de champiñones', 'Pescado frito', 'Tarta de manzana'),
(31, 13, 'Ensalada de aguacate', 'Carnitas', 'Helado de fresa'),
(32, 16, 'Sopa de garbanzos', 'Enchiladas suizas', 'Flan casero'),
(33, 21, 'Sopa de lentejas', 'Tacos de cabeza', 'Pudín de pan'),
(34, 24, 'Crema de espárragos', 'Mole poblano', 'Pastel de queso'),
(35, 29, 'Sopa de tortilla', 'Tacos de birria', 'Tiramisú');
...
(105, '2023-07-26 05:58:60', 0, 'AAAA030125HDFLVLA2', 'SACC030606HMCNLRA2', 29, 33),
